...
Autonomous mobile robots are being developed to operate in human populated spaces, such as homes and offices~\cite{hawes2016strands}. It is useful for these robots to predict patterns of human activity, so as to plan activities involving humans~\cite{2020AAMAS_street} or to support learning~\cite{coppola2016learning,duckworth2016a}. This paper is concerned with how a robot can correctly count how many human activities it has encountered, predict how many will occur in a particular location at a particular time, and how it can use both of these to drive exploration so as to observe as many human activities as possible during a deployment.
